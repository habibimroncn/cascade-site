jQuery(document).ready(function($) {
	...
	// swap a couple profile images on node 94
	//$("div#block-views-staff-block_2 div.view-rows-1 img").attr("src", "/sites/all/themes/cascadegroup/images/tom-with-map.jpg");
	//$("div#block-views-staff-block_2 div.view-rows-2 img").attr("src", "/sites/all/themes/cascadegroup/images/randy-with-map.jpg");
...
/*
	console.log('this is the array: ' + e);
