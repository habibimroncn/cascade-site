jQuery(document).ready(function($) {
	...
	var html = '<div id="popup" class="modal-box">';
	    ...
	    html += '<div class="contact-phone"><a href="tel:1-800-228-3065"><div class="icon-contact-phone"></div><label>Give us a ring:<br />800-228-3065</label></a></div><div class="contact-email"><a href="mailto:info@CHGsales.com"><div class="icon-contact-email"></div><label>Drop us an email</label></a></div><div class="visit-website"><a href="#" window.open("http://www.cascadehardwood.com", "_system");><div class="icon-visit-website"></div><label>Visit our website</label></a></div>';
	    html += '</div></div>';
